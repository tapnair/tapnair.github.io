...
r=function(){dpi=window.devicePixelRatio;$('.js-26').attr('src', (dpi>1) ? 'images/windows-result-946-1.png' : 'images/windows-result-473-2.png');
$('.js-27').attr('src', (dpi>1) ? 'images/osx-result-838-1.png' : 'images/osx-result-419-2.png');
$('.js-28').attr('src', (dpi>1) ? 'images/mas_results-1900-1.jpg' : 'images/mas_results-950-1.jpg');
$('.js-29').attr('src', (dpi>1) ? 'images/scripts-addins-850.png' : 'images/scripts-addins-425-1.png');
$('.js-30').attr('src', (dpi>1) ? 'images/archiver-addin-468-1.png' : 'images/archiver-addin-234-1.png');};
