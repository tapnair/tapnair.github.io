...
$('.js-16').mouseenter(function() { $.loadImages('images/cover_image-743.jpg', function() { }) });
$('.js-16').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-16-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/cover_image-743.jpg'; } } });
$('.js-17').mouseenter(function() { $.loadImages('images/cover_image-510.png', function() { }) });
$('.js-17').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-17-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/cover_image-510.png'; } } });
...
$('.js-20').mouseenter(function() { $.loadImages('images/readmecover-235.png', function() { }) });
$('.js-20').magnificPopup({ type: 'image', closeOnContentClick: true, closeBtnInside: false, mainClass: 'mfp-fade js-20-lightbox mfp-no-margins mfp-with-zoom', image: { verticalFit: true }, zoom: { enabled: true, duration: 300 }, callbacks: { elementParse: function(item) { item.src = 'images/readmecover-235.png'; } } });
