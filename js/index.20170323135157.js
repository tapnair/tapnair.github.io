...
$('.js-6').attr('src', (dpi>1) ? 'images/configsavermenu-254.png' : 'images/configsavermenu-127-1.png');

$('.js-8').attr('src', (dpi>1) ? 'images/dialog-414.png' : 'images/dialog-207-1.png');
$('.js-9').attr('src', (dpi>1) ? 'images/nester_cover-440-1.jpg' : 'images/nester_cover-220-1.jpg');
...
$('.js-13').attr('src', 'images/twitter-61.png');
